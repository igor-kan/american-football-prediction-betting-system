...
Repository-specific working guide for coding agents on **American Football Prediction and Betting System**.

## Snapshot
- Repository: `american-football-prediction-betting-system`
- Path: `/home/igorkan/repos/american-football-prediction-betting-system`
- Purpose: Production-oriented repository for American Football outcome prediction and betting execution using publicly available data.
