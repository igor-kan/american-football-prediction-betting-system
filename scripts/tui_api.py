#!/usr/bin/env python3
"""Curses TUI client for American Football Prediction and Betting API."""
...
def draw(stdscr: curses.window, base_url: str, output: str) -> None:
    ...
    title = f"American Football API TUI  |  base: {base_url}"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="TUI for American Football API")
